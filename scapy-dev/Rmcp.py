...
# usage:
"""
Basic tool to fuz ipmi chips. Use with Caution on non production environement.
"""
...
class Rmcp(Packet):
    """
    Build a ipmi / rmcp packet with reasoneable default attributes
    ipmi provides a lot of functions like fan speed, console, power consumption, led status ...
    The plan here is to implement a base that goes up to the login and then let you play with the primitive you're into
    """
